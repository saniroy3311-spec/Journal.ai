    ...
    <>
      ...
      <header className="hidden md:flex items-center justify-between px-8 py-4 border-b border-[#D9D9D2]/70 bg-white/80 backdrop-blur-md sticky top-0 z-40">
        ...
        <div className="flex items-center gap-3">
          <div className="w-9 h-9 rounded-lg overflow-hidden border border-[#D9D9D2]/30 shadow-sm flex items-center justify-center bg-[#FAF6EE]">
            <img 
              src="/logo.png" 
              alt="Journal.ai Logo" 
      ...
      <header className="flex md:hidden items-center justify-between px-5 py-4 border-b border-[#D9D9D2]/70 bg-white/80 backdrop-blur-md sticky top-0 z-40 safe-top">
        <div className="flex items-center gap-2">
          <div className="w-8 h-8 rounded-lg overflow-hidden border border-[#D9D9D2]/30 shadow-sm flex items-center justify-center bg-[#FAF6EE]">
            <img 
              src="/logo.png" 
              alt="Journal.ai Logo" 
